...
<html lang="{{config("app.locale")}}">
    <head>
        <title>@yield("title", config("app.name") . " Walker")</title>
        <link rel="stylesheet" href="{{asset("/css/walker_styles.min.css")}}" />
        <link rel="shortcut icon" href="{{asset("/img/logo-blue.ico")}}" >
    ...
    <body>
        <div id="wrapper">
            <header id="header">
                @section("header")
                @include("walker.layouts.header")
                @show
            </header>
            <div id="content">
                <aside id="sidebar">
                    @section("sidebar")
                    @include("walker.layouts.sidebar")
                    @show
                </aside>
                <main id="main">
        ...
        <script src="{{asset("/js/walker_scripts.min.js")}}"></script>
        @if($hasMap)
        <script async defer
