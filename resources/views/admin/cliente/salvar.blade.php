...
@section("title") Alterar cliente | {{config("app.name")}} @endsection

@section("main")
<section>
    <h1>Alterar cliente</h1>
    <form id="form-cadastro-cliente" role="form" method="POST" action="{{route("admin.cliente.alterar.post", ["id" => $customer->idCliente])}}">
        {!! csrf_field() !!}
        <fieldset>
