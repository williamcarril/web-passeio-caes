...
<section>
    ...
    <div class="button-group pull-right">
        ...
        <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#cancelamento-modal">Cancelar agendamento</a>
        @endif
        ...
        <a href="#" class="btn btn-warning">Sugerir reagendamento</a>
        @endif
    </div>
